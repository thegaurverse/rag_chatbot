...
def main():
    ...
    if not api_available:
        ...
        if demo_query:
            ...
            To enable full functionality, the Space owner needs to add an OpenRouter API key in the Space settings.
            """)
        return
...
if __name__ == "__main__":
    ...
    st.markdown("**Powered by WHO Data • Built with Streamlit • Enhanced with AI • Hosted on 🤗 Hugging Face**")
